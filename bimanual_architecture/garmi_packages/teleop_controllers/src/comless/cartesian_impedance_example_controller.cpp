...
#include <teleop_controllers/comless/cartesian_impedance_example_controller.hpp>
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::CartesianImpedanceExampleController,
