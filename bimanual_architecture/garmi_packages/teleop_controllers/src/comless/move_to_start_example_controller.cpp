...
#include <teleop_controllers/comless/move_to_start_example_controller.hpp>
...
CallbackReturn MoveToStartExampleController::on_configure(
  ...
  auto start_joint_configuration = get_node()->get_parameter("start_joint_configuration").as_double_array();
  q_goal_ = Eigen::Map<const Vector7d>(start_joint_configuration.data());
  if (k_gains.empty()) {
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::MoveToStartExampleController,
