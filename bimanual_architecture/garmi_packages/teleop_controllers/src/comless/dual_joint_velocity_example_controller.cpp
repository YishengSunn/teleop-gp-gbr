...
#include "teleop_controllers/comless/dual_joint_velocity_example_controller.hpp"
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::DualJointVelocityExampleController,
