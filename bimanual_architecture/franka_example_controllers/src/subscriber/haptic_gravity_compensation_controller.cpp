#include <franka_example_controllers/subscriber/haptic_gravity_compensation_controller.hpp>
...
// Export plugin
PLUGINLIB_EXPORT_CLASS(franka_example_controllers::HapticGravityCompensationController,
