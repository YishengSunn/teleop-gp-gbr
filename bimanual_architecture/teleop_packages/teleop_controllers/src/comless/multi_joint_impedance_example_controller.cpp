...
#include <teleop_controllers/comless/multi_joint_impedance_example_controller.hpp>
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::MultiJointImpedanceExampleController,
