...
#include "teleop_controllers/comless/cartesian_velocity_example_controller.hpp"
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::CartesianVelocityExampleController,
