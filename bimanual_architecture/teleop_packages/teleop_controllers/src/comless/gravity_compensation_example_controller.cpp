...
#include <teleop_controllers/comless/gravity_compensation_example_controller.hpp>
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(teleop_controllers::GravityCompensationExampleController,
